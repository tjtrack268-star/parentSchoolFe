...
import { RotateCcw, Loader2, Users, Search, ChevronLeft, ChevronRight, X } from "lucide-react"
...
export default function OrgChartPage() {
  ...
  useEffect(() => {
    apiClient.get<ApiNode | ApiNode[]>("/admin/org-chart")
      .then(data => {
      ...
      <div className="border-b border-[#a3ade8]/30 bg-white px-4 py-3 shadow-sm space-y-2">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <button onClick={centerTree}
            className="flex shrink-0 items-center gap-2 rounded-lg border-2 border-[#3f2f85] px-4 py-2 text-sm font-semibold text-[#3f2f85] transition hover:bg-[#3f2f85] hover:text-white">
